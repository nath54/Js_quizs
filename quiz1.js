...
var q6={question:"Pourquoi les nobles ont peur lors de la Grande Peur",reponses:["le roi devient de plus en plus méchant","Les Anglais veulent leurs déclarer la guerre","Les paysans les attaquent dans la campagne"],br:3};
var q7={question:"Que fait le decret d'Allarde ?",reponses:["Il donne plus de libertés aux entrepreneurs","Il autorise les corporations","Il autorise la greve et les syndicats"],br:1};
var q8={question:"Qui se trouve à gauche de l'Assemblée nationale ?",reponses:["Les révolutionnaires qui veulent arreter la révolution","le roi","les revolutionnaires qui veulent continuer la revolution","Les revolutionnaires neutres"],br:3};
var q9={question:"Quelle est la seconde Assemblée Nationale ?",reponses:["la Constituante","la Convention","La Legislative"],br:3};
var q10={question:"Où est-ce que retrouvent des personnes ayant une opinion politique commune ?",reponses:["Dans un club politique","A l'Assemblée Nationale","Chez le roi"],br:1};
var q11={question:"Dans quel camp se trouve La Fayette ?",reponses:["Aux Montagnards","Aux Girondins","Au clubs des Feuillant"],br:3};
